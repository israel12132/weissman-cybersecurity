...
export const STRINGS = {
  en: {
    ...
    brandLabel: 'Weissman Cybersecurity — home', brandHref: '/', wordsub: 'Cybersecurity',
    ...
    cc: {
      ...
      brandLabel: 'Weissman Command Center', brandHref: '/command-center/', wordsub: 'Command Center',
    },
  },
  he: {
    lang: 'he', dir: 'rtl',
    ...
    skip: 'דילוג לתוכן',
    brandLabel: 'Weissman Cybersecurity — דף הבית', brandHref: '/he/', wordsub: 'Cybersecurity',
    switchHref: '/', switchLabel: 'English', switchLang: 'en', switchDir: 'ltr', switchTitle: 'English version',
    eyebrow: 'עדכון מתוכנן', eyebrowPlanned: 'תחזוקה מתוכננת',
    ...
    plannedTitle: 'חלון תחזוקה מתוכנן', plannedReason: 'מה מתעדכן', plannedUntil: 'חזרה צפויה עד',
    retry: 'בדקו שוב', retryHint: 'בודק זמינות מיד.', statusBtn: 'עדכוני סטטוס',

...
| Metric | Value | Verify |
|--------|-------|--------|
| Production engines | **593** | `node scripts/verify_engine_wiring.mjs` |
...
| Real probes | **331** | `node scripts/engine_reality_audit.mjs` |
...
| `scripts/verify_engine_wiring.mjs` | 593 engine IDs ↔ dispatch — 0 gaps |

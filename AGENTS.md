...
| Command Center routes | **132** (target ≥112) | `node scripts/weissman-ui-audit.mjs` |
| UI pages (audit) | **113/113** — all pages meet the Weissman UI standard (exit 0) | `node scripts/weissman-ui-audit.mjs` |
| Real probes | **304** | `node scripts/engine_reality_audit.mjs` |
...
| `scripts/verify_engine_wiring.mjs` | 564 engine IDs ↔ dispatch — 0 gaps |
| `scripts/weissman-ui-audit.mjs` | 132 routes (target ≥112), 113/113 pages — live API evidence rules; run for live numbers |

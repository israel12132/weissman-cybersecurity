...
| Metric | Value | Verify |
|--------|-------|--------|
| Production engines | **583** | `node scripts/verify_engine_wiring.mjs` |
...
| Real probes | **321** | `node scripts/engine_reality_audit.mjs` |
...
| `scripts/verify_engine_wiring.mjs` | 583 engine IDs ↔ dispatch — 0 gaps |

...
mod tests {
    ...
    #[test]
    fn non_2xx_status_is_never_a_leak() {
        assert!(!looks_like_leak(".git/config", 404, "[core]"));
        assert!(!looks_like_leak(".git/config", 500, "[core]"));
    }
    ...
    #[test]
    fn ssh_private_key_signatures_detected() {

...
pub fn sweep_once() -> usize {
    ...
    dropped = dropped.saturating_add(crate::engine_telemetry::evict_stale());
    dropped = dropped.saturating_add(crate::self_heal_recovery::evict_stale_last_fired());
    dropped = dropped.saturating_add(weissman_engines::openai_chat::evict_stale_maps());
    if dropped > 0 {

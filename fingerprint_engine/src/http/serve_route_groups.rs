...
pub fn mount_api_routes(root_routes: Router<Arc<AppState>>) -> Router<Arc<AppState>> {
    root_routes
        ...
        .route("/api/vngfw", get(api_vngfw_status))
        .route("/api/vngfw/policy", put(api_vngfw_policy_put))
        .route("/api/vngfw/apply", post(api_vngfw_apply))
        .route("/api/cnapp/refresh", post(api_cnapp_refresh))
        .route("/api/cnapp/status", get(api_cnapp_status))
        .route("/api/cnapp", get(api_cnapp_status).post(api_cnapp_refresh))
        .route("/api/heal-stats", get(api_heal_stats_tenant))
        .route("/api/soar", get(api_soar_index))
        ...
        .route("/api/clients/:id/report/xlsx", get(api_client_report_xlsx))
        .route("/api/clients/:id/dominion-pack", get(api_client_dominion_pack))
        .route(

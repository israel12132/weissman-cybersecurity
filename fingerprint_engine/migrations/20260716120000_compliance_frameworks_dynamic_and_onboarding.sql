...
VALUES
    ...
    ('IEC62443', 'FR-1', 'Identification and authentication control', 'Foundational Requirements', NULL, 'login_lockout', 'redis', 'Authentication with distributed login lockout and rate limiting'),

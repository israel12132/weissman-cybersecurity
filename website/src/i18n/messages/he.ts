...
export const he = {
  seo: {
    home: {
      ...
      description:
        'Weissman בודק ברציפות משטחי תקיפה מאושרים עם 573 מנועי ייצור, מאמת ממצאים בראיות חיות, ומסייע לצוותי SOC לתעדף ולהגיב.',
    },
    platform: {
    ...
    'vulnerability-research': {
      ...
      description:
        '313 בדיקות חיות ב-web, ענן, OT, זהות ושרשרת אספקה — כל ממצא מגיע מבדיקת רשת או מארח אמיתית.',
    },
    'detection-response': {
    ...
    contact: {
      ...
      description: 'בקשו הדגמה של Weissman או דברו עם הצוות על פריסת הפלטפורמה בסביבה שלכם.',
    },
    pricing: {
      title: 'שירותים — Weissman Cybersecurity',
      description:
        'Weissman לא נמכר כחבילות מדף באתר. צרו קשר כדי להתאים את הפלטפורמה לארגון. לקוחות קיימים נכנסים ל-Command Center.',
    },
    signup: {
      title: 'בקשת גישה — Weissman Cybersecurity',
      description: 'צרו קשר עם Weissman לבקשת גישה לפלטפורמה. לקוחות קיימים נכנסים ל-Command Center.',
    },
    terms: {
  ...
  nav: {
    ...
    mega: {
      ...
      company: {
        ...
        pricing: { label: 'שירותים', description: 'צרו קשר להתאמת פריסה' },
  ...
  products: {
    ...
    'vulnerability-research': {
      ...
      summary:
        '313 בדיקות חיות — web, API, ענן, OT/ICS, זהות, שרשרת אספקה, AI/LLM ועוד. כינויים מגיעים למימוש אמיתי. CI נכשל אם לא.',
      ctaLabel: 'למנועי המחקר',
      outcomes: [
        '573 מזהי ייצור, כל אחד מחובר לראנר',
  ...
  resourcesPage: {
    ...
    items: {
      ...
      'mitre-coverage': {
        ...
        summary: '226 טכניקות: 194 מיפויים ראשוניים ועוד 32 תגיות משניות מעוגנות בקוד.',
      },
      'engine-integrity': {
        title: 'חשבונאות שלמות מנועים',
        summary: '573 מזהים מסווגים כבדיקה חיה, כינוי או דורש-סוכן — תחת שערי CI, בלי רשומות קטלוג שקטות.',
      },
      'platform-overview': {
  ...
  pricingPage: {
    eyebrow: 'שירותים',
    title: 'אין חבילות מדף. יש שיחה, ואז מתאימים את העבודה.',
    lead: 'מי שרוצה את Weissman בארגון יוצר קשר. אין תוכניות מדף באתר. לקוחות קיימים נכנסים ל-Command Center.',
    emailLabel: 'כתבו אל',
    loginHint: 'כבר מחוברים כלקוח? היכנסו ל-Command Center עם פרטי הלקוח.',
    ...
    faqs: [
      ...
      {
        q: 'אפשר להריץ את הפלטפורמה בסביבה שלנו?',
        a: 'כן. הפריסה מותאמת איתכם — כולל הרצה ב-VPC שלכם עם Postgres, Redis ומודלים פרטיים לפי הצורך. צרו קשר ונעבור על האפשרויות מול האילוצים שלכם.',
      },
      {
      ...
      {
        q: 'איך לקוחות קיימים נכנסים?',
        a: 'השתמשו ב״כניסת לקוחות״ בכותרת. זה פותח את Command Center ב־/command-center/login — אותו מישור בקרה שהמוצר רץ עליו, לא עותק שיווקי.',
      },
    ],
  },
  signupPage: {
    title: 'בקשת גישה',
    lead: 'סביבות עבודה נפתחות איתנו — לא כחבילה עצמית באתר. ספרו לנו על הסביבה, או היכנסו אם כבר יש לכם פרטי לקוח.',
    haveAccount: 'כבר לקוחות?',
  },
  notFound: {
    eyebrow: '404',
  ...
  demoJourney: {
    ...
    after: {
      title: 'אחרי השליחה',
      body: 'מומחה מוצר משיב מ-{email}. אם הפריסה הזו לא יכולה לשלוח דוא״ל — הטופס יגיד זאת ויציע מייל. הוא לא יעמיד פנים שהבקשה הגיעה.',
    },
    during: {
      title: 'מה תראו',

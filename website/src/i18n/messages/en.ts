...
export const en = {
  ...
  demoJourney: {
    ...
    after: {
      ...
      body: 'A product specialist replies from sales@weissman.io. If this deployment cannot send mail, the form says so and offers email — it never pretends the request landed.',
    },
    during: {

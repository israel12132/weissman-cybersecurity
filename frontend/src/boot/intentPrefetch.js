...
const CHAIN_PREDICT = {
  ...
  '/kill-chain': ['/campaigns', '/threat-emulation', '/exploit-lab', '/roe-approvals'],
  '/campaigns': ['/kill-chain', '/attack-paths', '/jobs', '/remediation'],
  '/threat-emulation': ['/campaigns', '/kill-chain', '/agents'],

  ...
  return (
    <div className="bg-[var(--table-surface)] backdrop-blur-md border border-[var(--border-default)] rounded-xl overflow-hidden">
      ...
      {error ? (
        ...
        <div className="p-4 text-sm text-[var(--text-muted)]">{t('pages.remediationHub.posture_empty')}</div>
      ) : (
        <div className="p-4 grid grid-cols-1 md:grid-cols-[auto,1fr,1fr] gap-6 items-center">
          ...
          <div className="flex flex-col items-center justify-center px-2">
            ...
            <div className="mt-1 flex items-center gap-2">
              ...
              <span className="text-[10px] text-[var(--text-muted)] uppercase tracking-wider">{t('pages.remediationHub.posture_of_100')}</span>
            </div>
          </div>
          ...
          {/* Drivers */}
          <div>
            <div className="text-[10px] uppercase tracking-wider text-[var(--text-muted)] mb-2">{t('pages.remediationHub.posture_drivers')}</div>
        ...
        <div className="px-4 pb-4 -mt-1">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {gradeMilestones(projection).map((s) => (
              <div key={s.after_fixing_rank} className="flex items-center gap-2 px-2.5 py-1.5 rounded-lg border border-[var(--border-default)] bg-[var(--bg-2)]">

    ...
    <>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className="rounded-2xl bg-[var(--bg-2)] backdrop-blur-md border border-[var(--border-default)] p-5 space-y-4">
          ...
          <p className="text-[11px] text-[var(--text-muted)] leading-relaxed">{t('pages.astFuzzingStudio.input_hint')}</p>
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <label className="text-[11px] font-mono text-[var(--text-muted)] flex items-center gap-2">

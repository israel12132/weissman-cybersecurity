        ...
        <div className="flex items-end gap-3 flex-wrap">
          <Field label={t('pages.jwtLab.client_label')}>
            <ScopedClientControl
              ...
              clients={clients}
              className="bg-[var(--scrim)] border border-[var(--border-default)] rounded-lg px-3 py-2 text-xs text-[var(--text-secondary)] font-mono focus:outline-none focus:border-[#a855f7]/40 min-w-[180px]"
              placeholder={t('pages.jwtLab.select_client')}
              allowEmpty
            />
          </Field>

...
export const KillChainCommander = React$lazy(() => import('../pages/KillChainCommander'))
export const PdfCommandCenter = React$lazy(() => import('../pages/PdfCommandCenter'))
export const C2CovertExfilCommandCenter = React$lazy(() => import('../pages/C2CovertExfilCommandCenter'))
export const HoneyRoutingGateway = React$lazy(() => import('../pages/HoneyRoutingGateway'))
export const LlmUltraGuard = React$lazy(() => import('../pages/LlmUltraGuard'))
export const StealthyPersistenceEvasion = React$lazy(() => import('../pages/StealthyPersistenceEvasion'))
export const FindingClusters = React$lazy(() => import('../pages/FindingClusters'))
export const CeoKeysCockpit = React$lazy(() => import('../pages/CeoKeysCockpit'))
export const AttackVectorAnalytics = React$lazy(() => import('../pages/AttackVectorAnalytics'))
export const AiReadiness = React$lazy(() => import('../pages/AiReadiness'))

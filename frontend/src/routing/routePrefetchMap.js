...
const EXACT = {
  ...
  '/attack-paths': () => import(/* webpackChunkName: "page-attack-paths" */ '../pages/AttackPaths.jsx'),
  '/cortex-bridge': () => import(/* webpackChunkName: "page-cortex-bridge" */ '../pages/CortexProvenBridge'),
  '/campaigns': () => import(/* webpackChunkName: "page-campaigns" */ '../pages/AdversaryCampaignFabric.jsx'),
  '/discovery-lab': () => import(/* webpackChunkName: "page-discovery-lab" */ '../pages/DiscoveryLab.jsx'),
  '/honey-routing': () => import(/* webpackChunkName: "page-honey-routing" */ '../pages/HoneyRoutingGateway.jsx'),
  '/llm-ultra-guard': () => import(/* webpackChunkName: "page-llm-ultra-guard" */ '../pages/LlmUltraGuard.jsx'),
  '/c2-covert-exfil': () => import(/* webpackChunkName: "page-c2-covert" */ '../pages/C2CovertExfilCommandCenter.jsx'),
  '/stealthy-persistence': () => import(/* webpackChunkName: "page-stealthy-persistence" */ '../pages/StealthyPersistenceEvasion.jsx'),
  ...
  '/dominion': () => import(/* webpackChunkName: "page-dominion" */ '../pages/DominionBoardPack.jsx'),

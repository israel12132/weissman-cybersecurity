...
export const EXPLICIT_PARAM_DEFS = {
  ...
  api_cloud_intel: [{ key:'intensity', label:'Scan Intensity', type:'select', options:['light','normal','aggressive'], defaultVal:'normal' },
                   { key:'timeout_ms', label:'Probe Timeout (ms)', type:'number', defaultVal:'8000', min:500, max:60000 },
                   { key:'evidence_mode', label:'Evidence Mode', type:'select', options:['standard','strict','forensic'], defaultVal:'strict' }],

...
export const EXPLICIT_PARAM_DEFS = {
  ...
  web_http_intel:  [{ key:'intensity',     label:'Probe Intensity',                 type:'select', options:['light','normal','aggressive'], defaultVal:'normal' },
                   { key:'evidence_mode',  label:'Evidence Mode',                   type:'select', options:['standard','strict','forensic'], defaultVal:'forensic' }],
  web_identity_surface: [{ key:'intensity', label:'Probe Intensity',                type:'select', options:['light','normal','aggressive'], defaultVal:'normal' },
                   { key:'evidence_mode',  label:'Evidence Mode',                   type:'select', options:['standard','strict','forensic'], defaultVal:'forensic' }],
  identity_attack_chain: [{ key:'include_password_spray', label:'Include password spray', type:'select', options:['true','false'], defaultVal:'true' },
                   { key:'include_kerberos', label:'Include Kerberos suite',         type:'select', options:['true','false'], defaultVal:'true' },
                   { key:'include_itdr', label:'Include ITDR telemetry',            type:'select', options:['true','false'], defaultVal:'true' },
                   { key:'include_oauth_oidc', label:'Include OIDC/OAuth posture',   type:'select', options:['true','false'], defaultVal:'true' },
                   { key:'include_web_identity_surface', label:'Include web identity surface', type:'select', options:['true','false'], defaultVal:'true' },
                   { key:'chain_synthesis', label:'Synthesize identity chains',      type:'select', options:['true','false'], defaultVal:'true' }],

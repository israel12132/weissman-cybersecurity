...
export const EXPLICIT_PARAM_DEFS = {
  ...
  asm:             [{ key:'ports',            label:'Ports',                       type:'text',     placeholder:'top | all | 80,443,8080-8090', defaultVal:'top' },
                   ...
                   { key:'max_subdomains',    label:'Max Subdomains (0 = unlimited)', type:'number',   placeholder:'0', defaultVal:'0', min:0, max:100000 },
                   { key:'live_ai_discovery', label:'Live AI path/subdomain generation', type:'select', options:['true','false'], defaultVal:'true' },
  ...
  first_mover_surface_delta: [
    ...
    { key: 'chain_web_engines', label: 'Enqueue takeover/leak/BOLA/JWT on new hosts', type: 'select', options: ['true', 'false'], defaultVal: 'true' },

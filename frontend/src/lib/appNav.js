...
export const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/kill-chain-commander', labelKey: 'nav.kill_chain_commander', icon: '⚔' },
      ...
      { to: '/stealth-persistence', labelKey: 'nav.stealth_persistence', icon: '👁' },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/pdf-intelligence', labelKey: 'nav.pdf_intelligence', icon: '📄' },
      { to: '/attack-vectors', labelKey: 'nav.attack_vectors', icon: '☄' },
      { to: '/ai-readiness', labelKey: 'nav.ai_readiness', icon: '🤖' },

...
export const PRIMARY_NAV = [
  ...
  { to: '/messages', labelKey: 'nav.messages', icon: '✉️' },
...
export const INTEL_MAP_QUICKNAV = [
  ...
  { to: '/cortex-bridge', labelKey: 'nav.cortex_bridge', color: 'rgba(249,115,22,0.85)' },
  { to: '/finding-clusters', labelKey: 'nav.finding_clusters' },
  { to: '/scan-finding-spine', labelKey: 'nav.scan_finding_spine' },
  ...
  { to: '/board-pack', labelKey: 'nav.board_pack', color: 'rgba(16,185,129,0.85)' },
...
export const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { to: '/finding-clusters', labelKey: 'nav.finding_clusters', icon: '▦' },
      { to: '/scan-finding-spine', labelKey: 'nav.scan_finding_spine', icon: '⌁' },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/threat-feeds', labelKey: 'nav.threat_feeds', icon: '📡' },
      { to: '/ueba', labelKey: 'nav.ueba', icon: '📈' },
      { to: '/entity-risk', labelKey: 'nav.entity_risk', icon: '⚡' },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/cortex-bridge', labelKey: 'nav.cortex_bridge', icon: '🔥' },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/control-plane', labelKey: 'nav.control_plane', icon: '🛡' },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/mssp-portal', labelKey: 'nav.mssp_portal', icon: '🏢' },

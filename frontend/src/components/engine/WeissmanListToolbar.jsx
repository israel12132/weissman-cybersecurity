      ...
      <div className="flex flex-wrap items-center gap-3 min-w-0">
        <div className="relative flex-1 min-w-[200px] max-w-md">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-2 rounded-xl bg-black/50 border border-white/10 text-[12px] font-mono text-white/85 placeholder-white/25 focus:outline-none focus:border-cyan-500/40 focus:ring-1 focus:ring-cyan-500/15"
          />
        </div>
        {children}
      </div>
      <div className="flex flex-wrap items-center gap-3 text-[10px] font-mono text-white/35 shrink-0">

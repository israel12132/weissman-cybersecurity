...
- **PostgreSQL 16 + pgvector** (תוסף-הווקטור מפעיל את זיכרון-ה-AI ואת חיזוק-הפנטסט). ~88 טבלאות-יישום על-פני סכמת-public מבוססת-דייר, סכמת `intel` גלובלית, ומראות EPSS/KEV; מוגדרות על-ידי **178 מיגרציות SQL** (~5,100 שורות).
...
| מיגרציות SQL | **178 קבצים**, ~5,097 שורות, **107 `CREATE TABLE`** |

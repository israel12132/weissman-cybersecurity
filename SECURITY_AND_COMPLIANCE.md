...
|--------|-------|--------------|
| Production engine IDs | **581** | `scripts/verify_engine_wiring.mjs` |
| Command Center routes | **130** | `scripts/weissman-ui-audit.mjs` |
| UI pages audited | **111/111** | same |
| Engine kinds | 319 real_probe (311 distinct impls), 204 alias, 58 agent_required, 0 no_path | `scripts/engine_reality_audit.mjs` |

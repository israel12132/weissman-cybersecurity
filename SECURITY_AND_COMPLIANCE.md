...
|--------|-------|--------------|
| Production engine IDs | **593** | `scripts/verify_engine_wiring.mjs` |
| Command Center routes | **155** | `scripts/weissman-ui-audit.mjs` |
| UI pages audited | **142/142** | same |
| Engine kinds | 331 real_probe (323 distinct impls), 204 alias, 58 agent_required, 0 no_path | `scripts/engine_reality_audit.mjs` |

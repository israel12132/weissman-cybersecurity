...
4. Optional: **`GET /api/engines/capabilities`** — 567 engines, kinds: `real_probe`, `alias`, `agent_required`.
...
### Minutes 14–20 — Engine integrity (567 engines)
...
Explain taxonomy: **307 real_probe**, **212 alias**, **48 agent_required** — no fake findings.

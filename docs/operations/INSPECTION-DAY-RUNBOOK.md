...
| Real probes | **329** | `node scripts/engine_reality_audit.mjs` |
| Agent-required surfaces | **59** | same |
...
4. Optional: **`GET /api/engines/capabilities`** — 595 engines, kinds: `real_probe`, `alias`, `agent_required`.
...
### Minutes 14–20 — Engine integrity (595 engines)
...
Explain taxonomy: **329 real_probe**, **204 alias**, **59 agent_required** — no fake findings.

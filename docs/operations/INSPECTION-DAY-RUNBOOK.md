...
| UI pages audited | **127/127** | `node scripts/weissman-ui-audit.mjs` |
...
4. Optional: **`GET /api/engines/capabilities`** — 573 engines, kinds: `real_probe`, `alias`, `agent_required`.
...
### Minutes 14–20 — Engine integrity (573 engines)
...
Explain taxonomy: **313 real_probe**, **212 alias**, **48 agent_required** — no fake findings.

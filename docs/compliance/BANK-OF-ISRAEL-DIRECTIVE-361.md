...
|---|---|---|
| מיפוי נכסי מידע קריטיים | 595 מנועי סריקה, מיפוי לפי MITRE ATT&CK | `scripts/verify_engine_wiring.mjs` |
...
| **סה"כ כיסוי** | **14/14 tactics** | **329 real_probe + 3 advisory-only + 204 aliases + 59 agent-required engines** |

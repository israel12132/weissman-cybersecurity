...
| Class | Count | Share |
|-------|------:|------:|
| **Live probes** (real network / host / TLS / DNS I/O) | 305 | 54.0% |
| Aliases (retag → a live probe, same detection logic) | 212 | 37.5% |
...
| **Catalog total** | **565** | 100% |

- **297 distinct probe implementations** back the 305 live
...
**192 distinct MITRE ATT&CK techniques**, with
...
Those platforms orchestrate *other people's* detections. Weissman ships **305 in-house

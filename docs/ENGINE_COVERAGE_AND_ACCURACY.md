...
| Class | Count | Share |
|-------|------:|------:|
| **Live probes** (real network / host / TLS / DNS I/O) | 306 | 54.1% |
...
| **Catalog total** | **566** | 100% |

- **298 distinct probe implementations** back the 306 live
...
Those platforms orchestrate *other people's* detections. Weissman ships **306 in-house

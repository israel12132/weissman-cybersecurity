...
| Class | Count | Share |
|-------|------:|------:|
| **Live probes** (real network / host / TLS / DNS I/O) | 331 | 55.8% |
| Aliases (retag → a live probe, same detection logic) | 204 | 34.4% |
...
- **323 distinct probe implementations** back the 331 live
...
Those platforms orchestrate *other people's* detections. Weissman ships **331 in-house

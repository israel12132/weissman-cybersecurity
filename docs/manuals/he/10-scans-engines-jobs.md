...
תפעול **559 מנועי production**, תור jobs, hubs ב-Command Center, gates של agent-required, ותזמון — למפעילי SOC.
...
**559 מנועים** ב-`PRODUCTION_ENGINE_IDS` (`backend/weissman-core/src/models/engine.rs`).

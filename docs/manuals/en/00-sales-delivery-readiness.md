...
| Area | Status | Notes |
|------|--------|-------|
| **Engine wiring** | ✅ Complete | `verify_engine_wiring.mjs` → 0 gaps; **595 production engine IDs** |
| **UI standard** | ✅ Complete | `weissman-ui-audit.mjs` → **95/95 pages**, **112 routes** |
| **Agent-required UX** | ✅ Complete | Empty state + per-route gates; **59 agent engines** |
...
4. `GET /api/engines/capabilities` → 595 engine IDs with kind legend

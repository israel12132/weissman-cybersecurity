...
Operate Weissman's **573 production security engines**, understand job queue mechanics, Command Center hubs, agent-required gates, and scan scheduling for SOC operators.
...
Weissman ships **573 production engines** registered in `PRODUCTION_ENGINE_IDS` (`backend/weissman-core/src/models/engine.rs`).

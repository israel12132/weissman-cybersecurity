...
Operate Weissman's **559 production security engines**, understand job queue mechanics, Command Center hubs, agent-required gates, and scan scheduling for SOC operators.
...
Weissman ships **559 production engines** registered in `PRODUCTION_ENGINE_IDS` (`backend/weissman-core/src/models/engine.rs`).

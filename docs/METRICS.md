...
| Rust test fns (`#[test]`/`#[tokio::test]`, incl. parameterized) | 4251 | grep over workspace |
| HTTP route registrations (`.route(`) | 472 | grep over `fingerprint_engine/src` + `backend` |
| Migrations — `crates/weissman-db/migrations` | 190 | `ls crates/weissman-db/migrations` |
| Migrations — `fingerprint_engine/migrations` | 190 | `ls fingerprint_engine/migrations` |

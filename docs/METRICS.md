...
| Rust test fns (`#[test]`/`#[tokio::test]`, incl. parameterized) | 2556 | grep over workspace |
| HTTP route registrations (`.route(`) | 342 | grep over `fingerprint_engine/src` + `backend` |
| Migrations — `crates/weissman-db/migrations` | 117 | `ls crates/weissman-db/migrations` |
| Migrations — `fingerprint_engine/migrations` | 117 | `ls fingerprint_engine/migrations` |

...
| Rust test fns (`#[test]`/`#[tokio::test]`, incl. parameterized) | 4230 | grep over workspace |
| HTTP route registrations (`.route(`) | 462 | grep over `fingerprint_engine/src` + `backend` |
| Migrations — `crates/weissman-db/migrations` | 188 | `ls crates/weissman-db/migrations` |
| Migrations — `fingerprint_engine/migrations` | 188 | `ls fingerprint_engine/migrations` |

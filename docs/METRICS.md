...
| Rust test fns (`#[test]`/`#[tokio::test]`, incl. parameterized) | 2407 | grep over workspace |
| HTTP route registrations (`.route(`) | 335 | grep over `fingerprint_engine/src` + `backend` |
| Migrations — `crates/weissman-db/migrations` | 93 | `ls crates/weissman-db/migrations` |
| Migrations — `fingerprint_engine/migrations` | 93 | `ls fingerprint_engine/migrations` |

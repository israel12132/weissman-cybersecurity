...
| Rust test fns (`#[test]`/`#[tokio::test]`, incl. parameterized) | 2914 | grep over workspace |
| HTTP route registrations (`.route(`) | 364 | grep over `fingerprint_engine/src` + `backend` |
| Migrations — `crates/weissman-db/migrations` | 140 | `ls crates/weissman-db/migrations` |
| Migrations — `fingerprint_engine/migrations` | 140 | `ls fingerprint_engine/migrations` |
